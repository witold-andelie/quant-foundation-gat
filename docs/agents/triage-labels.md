...
For the local-markdown tracker, record the role string in the `Status:`
line of the issue file. For GitHub, apply it as a label
(`gh issue edit <n> --add-label "<role>"`); create the label first if it
does not exist.
